...
const API_BASE = import.meta.env.VITE_CALENDAR_API_BASE || 'https://sd818uuj5ecdfn0ioahc0.apigateway-cn-beijing.volceapi.com'
  ...
  useEffect(() => {
    ...
    async function loadCalendar() {
      try {
        ...
        if (active) {
          setState({ loading: false, error: '日历加载失败', data: null })
        }
      }
    }
